        ...
        <div className='flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24'>
          <div className='text-center xl:text-left order-2 xl:order-none'>
            ...
            <h1 className='h1 mb-6'>
              <span className='text-accent'>Thiago Berenger</span>
            </h1>
            <p className='max-w-[500px] mb-9 text-white/80'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae qui, quis excepturi modi necessitatibus maxime. Voluptas enim, minus dicta cumque aspernatur repellat corporis quod.</p>
